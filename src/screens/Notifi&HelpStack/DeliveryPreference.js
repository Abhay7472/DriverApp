              ...
              {showSlot ? (
                ...
                <>
                  ...
                  <Text style={styles.grey}>
                    Every four hour ride must a four hour gap
                  </Text>
                  <View style={{alignItems: 'center'}}>
                    <TouchableOpacity
                      style={
                        timeSlot1 ? styles.slotSelected : styles.slotUnSelected
                      }
                      onPress={() => {
                    ...
                    <TouchableOpacity
                      style={
                        timeSlot2 ? styles.slotSelected : styles.slotUnSelected
                      }
                      onPress={() => {
                    ...
                    <TouchableOpacity
                      style={
                        timeSlot3 ? styles.slotSelected : styles.slotUnSelected
                      }
                      onPress={() => {
                    ...
                    <TouchableOpacity
                      style={
                        timeSlot4 ? styles.slotSelected : styles.slotUnSelected
                      }
                      onPress={() => {
