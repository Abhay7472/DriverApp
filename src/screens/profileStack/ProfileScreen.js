        ...
        <ScrollView style={{marginBottom: 80}}>
              ...
              <Card
                ...
                <Text
                  style={[
                    ...
                    {fontSize: 45, fontWeight: 'bold', marginTop: -5},
                  ]}>
                  {data?.deliveries}
                </Text>
                <Text style={[styles.infoBoxWrapper, {fontSize: 15}]}>
                  Deliveries
                </Text>
              </Card>
            </View>
            <View style={styles.infoBox}>
              <Card
                ...
                <Text
                  style={[
                    styles.infoBoxWrapper,
                    {fontSize: 42, fontWeight: 'bold', marginTop: -5},
                  ]}>
                  {data?.pickups}
                </Text>
                <Text style={[styles.infoBoxWrapper, {fontSize: 15}]}>
          ...
          <View style={{paddingHorizontal: 30}}>
            ...
            <View style={styles.action}>
              <TextInput
                placeholder={
                  contactNo != '' ? contactNo : 'Enter Contact Number'
                }
          ...
          <View
            style={{paddingHorizontal: 40, paddingBottom: 5, paddingTop: 20}}>
          ...
          <View style={{paddingHorizontal: 30}}>
            ...
            <View style={styles.action}>
              <TextInput
                placeholder={
                  routingNo != '' ? routingNo : 'Enter Routing Number'
                }
                placeholderTextColor="#fff"
                value={routingNo}
                style={styles.textInput}
          ...
          <View style={{paddingHorizontal: 30}}>
            ...
            <View style={styles.action}>
              <TextInput
                placeholder={
                  accountNo != '' ? accountNo : 'Enter Account Number'
                }
                placeholderTextColor="#fff"
                value={accountNo}
                style={styles.textInput}
