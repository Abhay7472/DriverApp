      ...
      <SafeAreaView style={loginStyles.container}>
        ...
        opacity: Animated.add(0.1, Animated.multiply(fall, 1.0)),
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseDriverLicensePhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseBackgroundCheckPhoto} style={styles.cameraIcon} >
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseRegistrationPhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseLicensePlateNoPhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseInsurancePhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                <Text style={{fontSize:15,flex:0.8, color:'#fff', paddingLeft: 10,paddingBottom: 15,}}>
                    Driver Photo
                </Text>
                <TouchableOpacity onPress = {chooseDriversPhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                ...
                />
                <TouchableOpacity onPress = {chooseSocialSecurityNoPhoto} style={styles.cameraIcon}>
            ...
            <View style={styles.action}>
                ...
                <TouchableOpacity onPress = {() => bs.current.snapTo(0)} style={styles.cameraIcon}>
