...
export const checkBreakTime = () => {
  const URL = Constants.BASE_URL+Constants.SUB_URL+Constants.CHECK_BREAK_TIME;
    token = null;
    token = getuser()  
  return fetch(URL,{
      headers: {
...
export const startBreakTime =(timeSlot, driverRow)=>{
  const URL = Constants.BASE_URL+Constants.SUB_URL+Constants.START_BREAK_TIME;
   token = null;
    token = getuser()
...
export const setDeliverySLot =(date,working,prefValue,timeSlot1,timeSlot2,timeSlot3,timeSlot4)=>{
